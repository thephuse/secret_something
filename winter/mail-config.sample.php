<?php 
  ...
  $mail_config_Host = 'smtp1.example.com';        // Specify main and backup SMTP servers, for Mandrill use smtp.mandrillapp.com
  $mail_config_SMTPAuth = true;                   // Enable SMTP authentication
  $mail_config_Username = 'user@example.com';     // SMTP username
  $mail_config_Password = 'secret';               // SMTP password
